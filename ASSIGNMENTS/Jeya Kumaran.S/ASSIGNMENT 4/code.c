...
#define ORG "jqr6mg"//IBM ORGANITION ID
#define DEVICE_TYPE "generaldevice"//Device type mentioned in ibm watson IOT Platform #define DEVICE_ID "generaldevice"//Device ID mentioned in ibm watson IOT Platform #define TOKEN "25214317" //Token
String data3;
char server[] = ORG ".messaging.internetofthings.ibmcloud.com"; char publishTopic[] = "iot-2/evt/Data/fmt/json";
char subscribetopic[] = "iot-2/cmd/test/fmt/String"; char authMethod[] = "use-generaldevicetoken-auth"; 
